...
%Extract LED spot by using 95% max value cutoff
XY = [];
...
%Load and convert each collection sample from 1.3 to 2.2 V
...
Std = [XY,Std130,Std140,Std150,Std160,Std170,Std180,Std190,Std200,Std210,Std220];
...
save('PixelCalibrationMatrix','XY_DN','Std')
